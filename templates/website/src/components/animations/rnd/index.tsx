    ...
    <div className={`relative ${className}`}>
      ...
      >
        ...
        <g className="security-layers" filter="url(#rnd-soft)">
          ...
          <text x="150" y="115" textAnchor="middle" fill="#10b981" fontSize="9" opacity="0.7">
            ACCESS
          </text>
        ...
        <g className="lab-zone">
          ...
          {/* Header du lab */}
          <rect x="320" y="60" width="240" height="32" rx="16" fill="#3b82f6" opacity="0.2" />
          <text x="440" y="82" textAnchor="middle" fill="#3b82f6" fontSize="11" fontWeight="600">
          ...
          <g transform="translate(370, 140)" filter="url(#rnd-soft)">
            ...
            <g>
              ...
              {/* Points de connexion */}
              <circle cx="-12" cy="-15" r="2" fill="#8b5cf6" opacity="0.8" />
              <circle cx="12" cy="-15" r="2" fill="#8b5cf6" opacity="0.8" />
              <circle cx="-12" cy="0" r="2" fill="#a78bfa" opacity="0.8" />
              <circle cx="12" cy="0" r="2" fill="#a78bfa" opacity="0.8" />
              <circle cx="-12" cy="15" r="2" fill="#8b5cf6" opacity="0.8" />
              <circle cx="12" cy="15" r="2" fill="#8b5cf6" opacity="0.8" />
            </g>

            <text x="0" y="50" textAnchor="middle" fill="#8b5cf6" fontSize="8" opacity="0.7">
              GENOMICS
            </text>
          </g>
          ...
          <g transform="translate(510, 140)" filter="url(#rnd-soft)">
            ...
            <g>
              ...
              <circle cx="-15" cy="8" r="5" fill="#fbbf24" opacity="0.5" />
              <circle cx="15" cy="8" r="5" fill="#fbbf24" opacity="0.5" />
          ...
          <g transform="translate(370, 235)" filter="url(#rnd-soft)">
            ...
            <g>
              <polygon
                ...
                opacity="0.7"
              />
              <circle cx="0" cy="-16" r="3" fill="#ec4899" opacity="0.6" />
              <circle cx="14" cy="-8" r="3" fill="#f472b6" opacity="0.5" />
              <circle cx="14" cy="8" r="3" fill="#ec4899" opacity="0.6" />
              <circle cx="0" cy="16" r="3" fill="#f472b6" opacity="0.5" />
              <circle cx="-14" cy="8" r="3" fill="#ec4899" opacity="0.6" />
              <circle cx="-14" cy="-8" r="3" fill="#f472b6" opacity="0.5" />

              {/* Centre pulsant */}
              <circle cx="0" cy="0" r="4" fill="#ec4899" opacity="0.4">
            ...
            <text x="0" y="50" textAnchor="middle" fill="#ec4899" fontSize="8" opacity="0.7">
              CHEMISTRY
            </text>
          </g>
          ...
          <g transform="translate(510, 235)" filter="url(#rnd-soft)">
            ...
            <g>
              ...
              <circle cx="-8" cy="-6" r="2" fill="#22d3ee" opacity="0.6">
                <animate
                  attributeName="opacity"
                  values="0.3;0.8;0.3"
                  dur="1.2s"
            ...
            <text x="0" y="50" textAnchor="middle" fill="#06b6d4" fontSize="8" opacity="0.7">
              AI MODEL
            </text>
          </g>
        </g>
